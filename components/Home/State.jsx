...
const State = () => {
  return (
    <Container>
      <section className="p-4 my-6 md:p-8 bg-gray-100 shadow-lg text-gray-100">
        <div className="container grid grid-cols-1 gap-6 m-4 mx-auto md:m-0 md:grid-cols-2 xl:grid-cols-3">
          <div className="flex overflow-hidden rounded-lg bg-gray-900 text-gray-100">
            <div className="flex items-center justify-center px-4 bg-blue-400 dark:text-gray-800">
              <svg
